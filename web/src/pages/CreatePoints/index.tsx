...
// arrya ou objeto: manualmente informar o tipo da variável.
interface item{
    id: number;
    title: string;
    image_url: string;
...
const CreatePoint = () => {
    ...
    useEffect(() =>{
        // carregar as cidades sempre que as UF's mudar.
        if (selectedUF === "0"){
            return;
        }
    ...
    async function handleSubmit(event : FormEvent){
        ...
        data.append('longitutde', String(longitude));
        ...
        <div id="page-create-point">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <fieldset>
                    <legend>
                        <h2>Endereço</h2>
                        <span>Selecione endereço do mapa.</span>                        
                        <p>Posição: {initialPosition}</p>
                    </legend>
                    ...
                    <legend>
                        <span>Posição: {selectedPosition}</span>                        
                    </legend>
